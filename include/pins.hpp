...
// // 可选：板载单颗 NeoPixel(WS2812) 的数据脚
// #ifndef NEOPIXEL_PIN
//   // 针对 Seeed Studio XIAO ESP32S3，板载 RGB LED 接在 GPIO21
//   #if defined(ARDUINO_SEEED_XIAO_ESP32S3)
//     #define NEOPIXEL_PIN 21
//   #else
//     // 其他板默认不猜测，请在 platformio.ini 的 build_flags 中 -DNEOPIXEL_PIN=xx 指定
...
// #if (NEOPIXEL_PIN < 0)
//   #pragma message("提示：未定义板载 NeoPixel(NEOPIXEL_PIN)。如需点亮 RGB，请在 build_flags 中 -DNEOPIXEL_PIN=xx；XIAO ESP32S3 通常为 21。")
// #endif
